...
final class SecurityCsvPlugin {
  ...
  static class SecurityTradeCsvPlugin implements TradeTypeCsvWriter<SecurityQuantityTrade> {
     ...
     */
    public static final TradeTypeCsvWriter<SecurityQuantityTrade> INSTANCE = new SecurityTradeCsvPlugin();
  ...
  static class GenericSecurityTradeCsvPlugin implements TradeTypeCsvWriter<GenericSecurityTrade> {
     ...
     * The singleton instance of the plugin.
     */
    public static final TradeTypeCsvWriter<GenericSecurityTrade> INSTANCE = new GenericSecurityTradeCsvPlugin();
    ...
    public void writeCsv(CsvRowOutputWithHeaders csv, GenericSecurityTrade trade) {
      ...
      csv.writeCell(CURRENCY, trade.getProduct().getInfo().getPriceInfo().getCurrency());
      csv.writeCell(TICK_VALUE, trade.getProduct().getInfo().getPriceInfo().getTickValue());
